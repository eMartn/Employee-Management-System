...
public class EmployeeController {
    ...
    public String viewHomePage(Model model) {
        ...
        //	We can use this attribute "listEmployees" to perform server-side rendering of the HTML using Thymeleaf.
    ...
    public String showNewEmployeeForm(Model model) {
        ...
        // We can use this attribute "employee" to perform server-side rendering of the HTML using Thymeleaf.
    ...
    //	@ModelAttribute binds the object called "employee" of request body from the POST request into the employee
    public String saveEmployee(@ModelAttribute("employee") Employee employee) {

        //	parameter of the saveEmployee() method.
    ...
    // @PathVariable binds the {id} in the GET request path with the id parameter of showUpdateForm() method.
